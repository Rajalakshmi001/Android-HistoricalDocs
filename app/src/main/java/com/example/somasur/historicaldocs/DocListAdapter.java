package com.example.somasur.historicaldocs;//package edu.rosehulman.historicaldocs;
...
import com.example.somasur.historicaldocs.Fragments.DocListFragment;
import com.example.somasur.historicaldocs.utils.DocUtils;
...
public class DocListAdapter extends RecyclerView.Adapter<DocListAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            mTitleTextView = itemView.findViewById(R.id.document_title_text_view);
        }
    }
}
